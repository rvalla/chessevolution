...
if player["plot_bullet"]:
	...
	game_count_scatter([player["name"] + " 's " + " bullet games:", "Time", "Games"], "bullet", get_player_limits(player["games_limits"], "bullet"), player["week_interval"])
...
if player["plot_blitz"]:
	...
	game_count_scatter([player["name"] + " 's " + " blitz games:", "Time", "Games"], "blitz", get_player_limits(player["games_limits"], "blitz"), player["week_interval"])
...
if player["plot_rapid"]:
	...
	game_count_scatter([player["name"] + " 's " + " rapid games:", "Time", "Games"], "rapid", get_player_limits(player["games_limits"], "rapid"), player["week_interval"])
